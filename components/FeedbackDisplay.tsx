...
const FeedbackDisplay: React.FC<FeedbackDisplayProps> = ({ message, type }) => {
  const baseClasses = "mt-4 p-3 md:p-4 rounded-md text-center font-semibold text-2xl md:text-3xl shadow"; // Increased font size
  const typeClasses = type === 'positive' 
    ? "bg-green-100 text-green-700 animate-pop-scale" 
    : "bg-red-100 text-red-700 animate-shake-short";
